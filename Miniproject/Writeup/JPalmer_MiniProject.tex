...
\begin{figure}[H]
	\centering
	\includegraphics[scale= 1]{../Results/Plots/ttest.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale= 1]{../Results/Plots/model_pdf_cdf.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width= 14cm]{../Results/Plots/bootstrap_model_aic.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width= 14cm]{../Results/Plots/bootstrap_model_aic_corrected.pdf}
